...
class ChatViewController: UIViewController , UITableViewDelegate ,UITableViewDataSource ,UITextFieldDelegate {
   ...
   func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //        let messageArray = ["message1","message2","message3"] (These lines of code meant to be deleted because send messages has been improved!!)
    ...
    @IBAction func sendPressed(_ sender: AnyObject) {
        ...
        messagesDB.childByAutoId().setValue(messagesDictionary){
            ...
            if error != nil {
                ...
                print("message saved successflly!")
            }
    ...
    func retrieveMessages()
    {
        ...
        messagesDB.observe(.childAdded) { (snapshot) in
           ...
           self.configureTableView() //reformatting tableview
